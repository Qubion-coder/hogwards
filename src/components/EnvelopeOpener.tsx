  ...
  return (
    <AnimatePresence mode="wait">
      {!showContent && (
        ...
        >
          {/* Background */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.08),transparent_35%),linear-gradient(135deg,#3e2723_0%,#4e342e_38%,#2e1c14_65%,#1a0f0a_100%)]" />
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            {petals.map((petal) => (
              ...
              >
                <div
                  className="h-5 w-3 rounded-full bg-gradient-to-b from-[#f2d89c] via-[#C9A227] to-[#4e342e] shadow-[0_0_14px_rgba(201,162,39,0.15)]"
                  style={{
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 flex h-[58%] flex-col items-center justify-end px-8 pb-4 sm:pb-6 text-center">
                    ...
                    >
                      <h3 className="font-serif text-[1.7rem] tracking-[0.14em] text-[#2e1c14] drop-shadow-[0_2px_8px_rgba(0,0,0,0.18)] flex items-center justify-center gap-4 sm:gap-6">
                        <span>T</span>
                  ...
                  <motion.div
                    animate={{
                      ...
                      boxShadow: !isOpen
                        ? ['0 10px 30px rgba(1,31,26,0.45)', '0 10px 35px rgba(201,162,39,0.4)', '0 10px 30px rgba(1,31,26,0.45)']
                    ...
                    className="absolute left-1/2 top-[54%] z-20 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-[#f2d89c]/40 bg-[radial-gradient(circle_at_30%_30%,#7e191b_0%,#3e2723_55%,#2e1c14_100%)] shadow-[0_10px_30px_rgba(126,25,27,0.45)]"
                  >
                    <span className="font-serif text-lg text-[#f5e6c8]">S ✦ V</span>
                  </motion.div>
